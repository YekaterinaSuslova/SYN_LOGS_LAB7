...
public class Class {
    ...
    static java.util.logging.Logger log = java.util.logging.Logger.getLogger(Class.class.getName());

    // Объявление логировцика типа org.apache.log4j.Logger
    static org.apache.log4j.Logger log4j = org.apache.log4j.Logger.getLogger(Class.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        log.info("Start");
        log.log(Level.INFO, "Информационная");
        log.log(Level.WARNING, "Предупреждение");
        log.log(Level.SEVERE, "Серъёзная ошибка");
